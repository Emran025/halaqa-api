...
use App\Http\Controllers\Api\V1\Memberships\ListHalaqaStudentSummaryController;
...
use App\Http\Controllers\Api\V1\Profile\GetPublicTeacherController;
use App\Http\Controllers\Api\V1\Profile\GetStudentProfileController;
use App\Http\Controllers\Api\V1\Profile\ListAvailableTeachersController;
...
use App\Http\Controllers\Api\V1\Progress\GetStudentProgressController;
...
use App\Http\Controllers\Api\V1\Registrations\CreateHalaqaRegistrationRequestController;
...
use App\Http\Controllers\Api\V1\Registrations\ListHalaqaRegistrationRequestsController;
use App\Http\Controllers\Api\V1\Registrations\ListRegistrationRequestsController;
use App\Http\Controllers\Api\V1\Registrations\ListTeacherApplicationInboxController;
...
use App\Http\Controllers\Api\V1\Sessions\ListSessionsController;
...
Route::prefix('v1')->group(function (): void {
    ...
    Route::middleware('auth:sanctum')->group(function (): void {
        ...
        Route::model('teacherId', User::class);
        Route::model('studentId', User::class);
        Route::model('halaqaId', Halaqa::class);
        Route::post('halaqas/{halaqaId}/registration-requests', CreateHalaqaRegistrationRequestController::class);
        Route::get('halaqas/{halaqaId}/registration-requests', ListHalaqaRegistrationRequestsController::class);
        Route::get('student-applications', ListTeacherApplicationInboxController::class);
        Route::get('students/{studentId}', GetStudentProfileController::class);
        Route::get('students/{studentId}/progress', GetStudentProgressController::class);
        Route::get('teachers', ListAvailableTeachersController::class);
        Route::get('teachers/{teacherId}', GetPublicTeacherController::class);
        ...
        Route::get('halaqas/{halaqa}/students-summary', ListHalaqaStudentSummaryController::class);
